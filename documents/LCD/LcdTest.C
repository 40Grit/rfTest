...
void PicInit(void)
{
   ...
   // configure 4 a-to-d channels
   ADCON1 = 0b00001111;       // no a-to-d inputs
   ADCON0 = 0b00000000;       // Select channel RA0/AN0
   ADCON2 = 0b00010010;       // 4 Tad acquisition time, Fosc/32
   ...
   T0CONbits.T0PS2 = 1;        // 1:128 prescalar
   T0CONbits.T0PS1 = 1;
   T0CONbits.T0PS0 = 0;
   TMR0H = (BYTE)(T10MSEC >> 8);
   TMR0L = (BYTE)(T10MSEC & 0xff);
